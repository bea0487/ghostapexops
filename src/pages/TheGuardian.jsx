          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-300 text-xl leading-relaxed mb-8 max-w-2xl">
                Everything in Wingman, plus complete driver qualification file management and IFTA filing. One monthly fee. Zero compliance headaches.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-400 text-sm mt-4 italic">
                Need complete protection including CSA monitoring and DOT audit prep? Check out <Link to="/ApexCommand" className="text-fuchsia-400 hover:text-fuchsia-300 transition-colors">Apex Command</Link>.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
              Join the most popular tier chosen by owner-operators and small fleets. Let us handle everything so you can focus on driving.
            </p>
            <CTAButton text="Book FREE Consultation" variant="magenta" size="large" />
          </motion.div>
        </div>
