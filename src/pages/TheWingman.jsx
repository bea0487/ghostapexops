...
export default function TheWingman() {
  const includedFeatures = [
    ...
    "Phone Support — Direct line during business hours (Daily 10am-11pm Arizona time)",
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-400 text-sm mt-4 italic">
                Need these features? Check out <Link to="/TheGuardian" className="text-cyan-400 hover:text-cyan-300 transition-colors">The Guardian</Link> or <Link to="/ApexCommand" className="text-cyan-400 hover:text-cyan-300 transition-colors">Apex Command</Link> tiers.
              </p>
            </motion.div>
          </div>
        </div>
