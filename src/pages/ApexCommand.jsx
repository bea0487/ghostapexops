          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-300 text-xl leading-relaxed mb-8 max-w-2xl">
                The ultimate compliance package. Everything in Guardian, plus CSA monitoring, DataQ disputes, DOT audit preparation, and priority support. Your dedicated wingman has your six — completely.
              </p>
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-gradient-to-r from-cyan-500/10 via-fuchsia-500/10 to-cyan-500/10 border border-cyan-500/30 rounded-3xl p-10 text-center"
          >
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500/30 to-fuchsia-500/30 flex items-center justify-center mx-auto mb-6">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              When you're at Apex Command level, you never wait. Got a question? Need help with a roadside inspection? 
              Your dedicated wingman responds the same day, every time.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
              Take command of your compliance with the ultimate protection package. Your dedicated wingman is ready to have your six.
            </p>
            <CTAButton text="Book FREE Consultation" variant="gradient" size="large" />
          </motion.div>
        </div>
